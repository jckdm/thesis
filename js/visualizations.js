...
$(() => {
  ...
  const tools = {
    ...
    grapher: '<span>Grapher produces graphs which illuminate paths and hotspots and allow for segmentation and animation of a user\'s data.<br><br>Click each application ' + button + 'Microsoft Word</button> &nbsp; to toggle its visibility.<br><br>Click &nbsp; ' + button + 'Time</button> &nbsp; to toggle animation.<br><br>Click &nbsp; ' + button + 'Lines</button> &nbsp; to toggle the connectedness of animated points.<br><br>Hover on a point &nbsp; <svg width="10" height="10"><circle r="5" cx="5" cy="5" stroke="gray" fill="#D3D3D3"></rect></svg> &nbsp; to reveal its corresponding application.</span>',
    mapper: '<span>Mapper distributes data across quadrants and can be scaled to re-layer the encoded information.<br><br>Click &nbsp; ' + button + 'Hide 0</button> &nbsp; to toggle visibility of quadrants with no recorded value.<br><br>Click &nbsp; ' + button + 'Color by most used app</button> &nbsp; to toggle between a logarithmic gray-scale and a winner-takes-all colored scale.<br><br>Hover on a quadrant &nbsp; <svg width="15" height="15"><rect height="15" width="15" stroke="#262626" fill="#D3D3D3"></rect></svg> &nbsp; to view its breakdown of applications and spans.</span>',
    reader: '<span>Reader produces a readable pair of lists which highlight the texture and patterns created by inflection points where a user changes between applications.<br><br>Click &nbsp; ' + button + 'Show all text</button> &nbsp; or &nbsp; ' + button + 'Show all color</button> &nbsp; to toggle visibility of intermediate datapoints.<br><br>Click &nbsp; ' + button + 'Analyze data</button> &nbsp; to toggle visibility of an analysis report and to reveal a vertical bar alongside the user\'s longest period of continuous switching between two applications.<br><br> Hover on a rectangle &nbsp; <svg width="55" height="15"><rect height="15" width="55" stroke="#262626" fill="#D3D3D3"></rect></svg> &nbsp; to view connections to corresponding instances of the application. Click to lock and unlock connections.</span>',
    unsorted: '<span>Unsorted paths &nbsp; <svg width="40" height="2.5"><rect height="2.5" width="40" fill="#3CB371"></rect></svg> &nbsp; are rendered in random order—these paths are unpredictable in shape and difficult to trace.</span>',
    sorted: '<span>Sorted paths &nbsp; <svg width="40" height="2.5"><rect height="2.5" width="40" fill="#6666FF"></rect></svg> &nbsp; are rendered in chronological order according to the images\' timestamps, resulting in traceable, logical paths.</span>',
